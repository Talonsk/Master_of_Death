...
define config.name = _("Master_of_Death")
...
define config.version = "alfa-1.2"
...
{a=https://www.youtube.com/@vicfiress}youtube{/a}, {a=https://www.tiktok.com/@vicfireslol}tik tok{/a}, {a=https://t.me/vcfrs}telegram{/a}, {a=https://t.me/vicgayris}tg channel{/a}

whtguy - художник фонов:
{a=https://www.tiktok.com/@whtguy_}tik tok{/a}, {a=https://t.me/+sS6KBSaBN2hjMjky}telegram{/a}
...
Используемые шрифты:
Phorssa, Improv (Rus by sherbackoffalex)

Отдельная благодарность:
Антону (t2x2), Денису (drakeoffc), Илье (mazellovvv), Максиму (stintik) и Вове (bratishkinoff) за вдохновение и прохождение игры!
""")
...
define build.name = "Master_of_Death"
...
define config.save_directory = "Master_of_Death-1735840848"
...
define build.itch_project = "asreal7/master-of-death"
