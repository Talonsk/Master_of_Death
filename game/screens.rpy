        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    # Я скрыл пропуск переходов, чтобы не было конфликтов музыки и картинки в игре
...
screen gallery():
    ...
    use game_menu(_('Галерея')):
        ...
        grid 1 2:
            ...
            add g.make_button('gallery', 'meme/galary_icon.png', xalign=0.5, yalign=0.5)
            textbutton _('Галерея') action(g.Action('gallery')) at xpos(0.45) ypos(-0.15)
